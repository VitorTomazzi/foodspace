...
//route for seeding DB from Spoonacular API. Once database is seeded we comment this out
...
// 	req.headers({
// 		'x-rapidapi-host': 'API_HOST', //in env file
// 		'x-rapidapi-key': 'API_Key' //in env file
// 	});
...
router.get('/details/:id', (req, res, next) => {
	...
	Recipe.findById(id).populate('author').then((theRecipe) => {
